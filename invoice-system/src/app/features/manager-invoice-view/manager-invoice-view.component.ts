...
@Component({
  selector: 'app-manager-invoice-view',
  standalone: true,
  imports: [
  ...
  templateUrl: './manager-invoice-view.component.html',
  styleUrl: './manager-invoice-view.component.scss'
})
export class ManagerInvoiceViewComponent implements OnInit {
